...
const Banner = () => {
  return (
    <div>
      <article
        id="home"
        className="relative w-full laptop:h-[80vh] flex flex-col items-center justify-start laptop:justify-center laptop:flex-row pt-12 laptop:pt-12"
      >
        <figcaption className="section_hidden relative w-full laptop:w-[50%] flex flex-col items-center laptop:items-start justify-center py-12 pl-5 text-center ">
          <h2 className="text-2xl tablet:text-4xl uppercase font-bold ">
            I&aposm <span className="text-orange-600">Alfred Gichia </span>
          </h2>
          ...
          <a
            ...
            className="bg-orange-600 hover:bg-orange-500 h-12 rounded-lg px-4  text-white w-[80%] tablet:w-56 flex flex-row items-center justify-center mx-auto laptop:mx-0"
          >
            View Resume
          </a>
        </figcaption>
        ...
        <div className="custom-shape-divider-bottom-1694798206">
          <svg
            data-name="Layer 1"
